...
export function JobProfileForm({ jobProfile, onSaved, onCancel, onDelete }: JobProfileFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
                <div>
                    <label className="input-label" htmlFor="role_name">
                        Role Name *
                    </label>
                ...
                <div>
                    <label className="input-label" htmlFor="technology">
                        Technology *
                    </label>
                    <div className="relative">
