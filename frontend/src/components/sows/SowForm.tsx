...
export interface SowFormProps {
    /** When set, update existing SOW; otherwise create. */
    sow?: SOW;
    onSaved: (updatedIsActive?: boolean) => void;
    onCancel: () => void;
}

export function SowForm({ sow, onSaved, onCancel }: SowFormProps) {
    ...
    useEffect(() => {
        Promise.all([jobProfileApi.list(), clientsApi.list()])
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                    <label className="input-label" htmlFor="sow_number">
                        SOW Number *
                    </label>
                ...
                <div className="md:col-span-2">
                    <label className="input-label" htmlFor="client_name">
                        Client *
                    </label>
                    <div className="relative">
                ...
                <div className="md:col-span-2">
                    <label className="input-label" htmlFor="job_profile_id">
                        Linked Job Profile
                    </label>
                    <div className="relative">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setFormData({
                                    ...formData,
                                    job_profile_id: e.target.value ? parseInt(e.target.value, 10) : undefined,
                                })
                            }
                        >
                ...
                <div>
                    <label className="input-label" htmlFor="target_date">
                        Target Date
                    </label>
                    <div className="relative">
                        <Calendar
                ...
                <div>
                    <label className="input-label" htmlFor="submitted_date">
                        Submitted Date
                    </label>
                    <div className="relative">
                ...
                <div className="md:col-span-2 space-y-4">
                    <div className="flex items-center gap-3">
                        <label className="input-label mb-0" htmlFor="max_resources">
                            Max Resources
                        </label>
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setFormData({ ...formData, max_resources: parseInt(e.target.value, 10) || 0 })
                                }
                                min="0"
                            />
                        </div>
            ...
            <div className="flex justify-end gap-3 pt-4">
                <button type="button" onClick={onCancel} className="btn btn-secondary px-6" disabled={loading}>
                    Cancel
                </button>
                <button type="submit" className="btn btn-primary px-8 flex items-center gap-2" disabled={loading}>
