            ...
            <Routes>
              ...
              <Route path="/" element={
                ...
                <Route path="job-profiles" element={
                  <ProtectedRoute allowedRoles={ADMIN_ROLES}><JobProfiles /></ProtectedRoute>
                } />
                <Route path="sows" element={
                  <ProtectedRoute allowedRoles={ADMIN_ROLES}><Sows /></ProtectedRoute>
                } />
                <Route path="vendors" element={
                  <ProtectedRoute allowedRoles={ADMIN_ROLES}><Vendors /></ProtectedRoute>
                } />
                <Route path="employees" element={
                  <ProtectedRoute allowedRoles={ADMIN_ROLES}><Employees /></ProtectedRoute>
                } />
                <Route path="timesheets" element={
                  <ProtectedRoute allowedRoles={ADMIN_ROLES}><Timesheets /></ProtectedRoute>
                } />
                <Route path="clients" element={
                  <ProtectedRoute allowedRoles={ADMIN_ROLES}><Clients /></ProtectedRoute>
                } />
              </Route>
